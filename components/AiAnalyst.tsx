  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex-1 bg-black/20 rounded-xl p-4 min-h-[100px] text-sm text-gray-300 leading-relaxed border border-white/5 overflow-y-auto custom-scrollbar">
          {analysis ? (
